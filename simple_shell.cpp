...
/**
 *  @brief Parse the command line into a vector of arguments.
 *  Check for mismatched quotes. Handle both quoted and unquoted tokens.
 ...
 * @brief Execute the command in a child process.
 * Wait for the child process to complete.
 * Print an error message if the command exits with a non-zero status.
